 ...
 *
*/
#ifndef _GAZEBO_PIXY_CAM_PLUGIN_HH_
#define _GAZEBO_PIXY_CAM_PLUGIN_HH_
...
namespace gazebo
{
  class GAZEBO_VISIBLE PixyCameraPlugin : public SensorPlugin
  {
    public: PixyCameraPlugin();

    /// \brief Destructor
    public: virtual ~PixyCameraPlugin();
